import 'package:persona_test/app/presentation/pages/overtime/detail_superior/overtime_detail_superior_controller.dart';
import 'package:persona_test/app/utils/constants.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter_clean_architecture/flutter_clean_architecture.dart';

class OvertimeDetailSuperiorPage extends View {
  static const route = '/overtime/detail/superior';

  final int idOT;

  OvertimeDetailSuperiorPage(this.idOT, {Key? key}) : super(key: key);

  @override
  // ignore: no_logic_in_create_state
  State<StatefulWidget> createState() {
    return _OvertimeDetailViewState(OvertimeDetailSuperiorController());
  }
}

class _OvertimeDetailViewState extends ViewState<OvertimeDetailSuperiorPage, OvertimeDetailSuperiorController> {
  final OvertimeDetailSuperiorController controller;
  ...
  Widget get view {
    ...
    return ControlledWidgetBuilder<OvertimeDetailSuperiorController>(builder: (context, controller) {
      return Stack(
        children: [
          ...
          Scaffold(
              ...
              body: SingleChildScrollView(
                child: Column(
                  children: [
                    SizedBox(
                      height: (controller.status == "1" || controller.status == "4")
                              ...
                              children: [
                                ...
                                TextButton(
                                  ...
                                  child: Container(
                                      ...
                                      child: ControlledWidgetBuilder<OvertimeDetailSuperiorController>(
                                ...
                                SizedBox(height: deviceSize.height * 0.02),
                                if (controller.status != "4" && controller.status != "5" && controller.status != "6")
                                  SizedBox(
                                    width: deviceSize.width * 0.9,
                                    child: RichText(
                                      text: const TextSpan(
                                ...
                                SizedBox(height: deviceSize.height * 0.02),
                                ControlledWidgetBuilder<OvertimeDetailSuperiorController>(
                                    builder: (context, controller) {
                    ...
                    if (controller.isCompleted == "0" && controller.status == "1")
                      SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  controller.postOvertimeUpdate(context, 2);
                                },
                            ...
                            SizedBox(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  controller.postOvertimeUpdate(context, 3);
                                },
                                style: TextButton.styleFrom(
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                    ...
                    if (controller.isCompleted == "0" && controller.status == "4")
                      SizedBox(
                        height: deviceSize.height * 0.065,
                        width: deviceSize.width * 0.9,
                        child: Row(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  controller.postOvertimeUpdate(context, 6);
                                },
                                style: TextButton.styleFrom(
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                                    backgroundColor: kPrimaryBlue),
                            ...
                            SizedBox(
                              ...
                              child: TextButton(
                                onPressed: () {
                                  controller.postOvertimeUpdate(context, 5);
                                },
                                style: TextButton.styleFrom(
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
